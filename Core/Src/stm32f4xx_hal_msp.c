...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC1_IN9
    */
    HAL_GPIO_DeInit(GPIOC, ADC1_OLC2_Pin|ADC1_OLC3_Pin|ADC1_OLC5_Pin|AKIM_FB_Pin);

    HAL_GPIO_DeInit(GPIOA, REF_Pin|L1_OLC_Pin|L2_OLC_Pin|L3_OLC_Pin
                          |I1_OLC_Pin|I2_OLC_Pin);

    HAL_GPIO_DeInit(GPIOB, I3_OLC_Pin|ADC1_OLC_Pin);
...
void HAL_DAC_MspDeInit(DAC_HandleTypeDef* hdac)
{
  ...
  /* USER CODE END DAC_MspDeInit 0 */
    ...
    PA5     ------> DAC_OUT2
    */
    HAL_GPIO_DeInit(GPIOA, DAC_VOLTAJ_OUT_Pin|DAC_AKIM_OUT_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PB11     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOB, SD_CARD_TX_Pin|SD_CARD_RX_Pin);
